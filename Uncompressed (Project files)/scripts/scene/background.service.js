(function () {
  ...
  function backgroundService () {
    ...
    function drawObject (scene, camera) {
      ...
      const backPlane = new THREE.Mesh(new THREE.PlaneBufferGeometry(300, 200), new THREE.MeshPhongMaterial({
        color: 0x6f4e37
      }))
      const sidePlane = new THREE.Mesh(new THREE.PlaneBufferGeometry(300, 200), new THREE.MeshPhongMaterial({
        color: 0x6f4e37
      }))
      const bottomPlane = new THREE.Mesh(new THREE.PlaneBufferGeometry(300, 300), new THREE.MeshPhongMaterial({
        color: 0x6f4e37
      }))
